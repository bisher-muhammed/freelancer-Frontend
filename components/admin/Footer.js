      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-2xl font-bold text-white">AdminPanel</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Comprehensive administrative control center for managing platform
              operations, users, and system configurations with full oversight
              capabilities.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center">
            <Mail className="h-5 w-5 mr-3 shrink-0" style={{ color: primaryColor }} />
            <span className="text-gray-400 text-sm">admin@freelancehub.com</span>
          </div>
          <div className="flex items-center">
            <Phone className="h-5 w-5 mr-3 shrink-0" style={{ color: primaryColor }} />
            <span className="text-gray-400 text-sm">+1 (555) 123-4567</span>
          </div>
          <div className="flex items-center">
            <MapPin className="h-5 w-5 mr-3 shrink-0" style={{ color: primaryColor }} />
